...
/**
 * Factory to create composer commands. Implementations must take care of getting the correct composer binary and should take care of setting the working
 * directory
 */
interface iComposerCommandFactory {
   ...
   *
   * @param string $command The composer command to run, e.g. 'install' or 'update'
